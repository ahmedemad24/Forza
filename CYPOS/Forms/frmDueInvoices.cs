...
namespace cypos
{
    public partial class frmDueInvoices : Form
    {
        ...
        public frmDueInvoices()
        {
            ...
            dgvDueInvoices.Columns[6].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        private void frmDueInvoices_Load(object sender, EventArgs e)
        {
            ...
            string strSQL = "SELECT tbl_InvoiceHeader.invoice_id,tbl_InvoiceHeader.invoice_no, tbl_InvoiceHeader.invoice_date," +
        ...
        private void dgvDueInvoices_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                frmPayment.InvoiceId = row.Cells[0].Value.ToString();
                frmPayment.InvoiceNo = row.Cells[1].Value.ToString();
                frmPayment.InvoiceDate = row.Cells[2].Value.ToString();
                frmPayment.Customer = row.Cells[3].Value.ToString();
                frmPayment.TotalAmount = row.Cells[4].Value.ToString();
                frmPayment.PaidAmount = row.Cells[5].Value.ToString();
                frmPayment.DueAmount = row.Cells[6].Value.ToString();
