...
namespace cypos.Forms
{
    public partial class frmStartShift : Form
    {
        ...
        private void frmStartShift_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (this.DialogResult == DialogResult.OK)
            {
                this.startDate = DateTime.Now;
                this.Amount = decimal.Parse(txtAmount.Text);
            }
            else
            {
                this.userId = null;
        ...
        private void frmStartShift_Load(object sender, EventArgs e)
        {
            ...
            this.txtUserName.Text = dt.Rows[0].ItemArray[0].ToString();
            ...
            this.dateShiftPicker.Value = this.timeShiftPicker.Value = DateTime.Now;
        }

        private void pnlLeftInner_Paint(object sender, PaintEventArgs e)
        {
