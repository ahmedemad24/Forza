        ...
        public void LoadOrders()
        {
            ...
            try
            {
                ...
                for (int i = 0; i < dtHeader.Rows.Count; i++)
                {
                    ...
                    string strSQLDetail = "SELECT item_code, item_name" 
                                        + ",CASE " 
                                        + "WHEN tbl_TempDetail.kot_qty > 0 " 
                                        + "THEN CONVERT(VARCHAR(MAX),qty) + ' [' + CONVERT(VARCHAR(MAX),kot_qty)  + ']' " 
                                        + "ELSE CONVERT(VARCHAR(MAX),qty) END AS qty,kot_qty, comment " 
                    ...
                    dgvItem.Columns[4].HeaderText = "Comment";
                    dgvItem.Columns[4].Name = "clmComment" + pnlOrder.Tag.ToString();
                    dgvItem.Columns[4].DataPropertyName = "comment";
                    dgvItem.Columns[4].Width = 50;
